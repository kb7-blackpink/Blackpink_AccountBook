...
export const getBarChartData = (
  ...
  // 현재 모드의 팔레트 선택
  const selectedPalette = mode === 'lucky' ? PALETTES.lucky : PALETTES.unlucky;

  // 데이터(막대) 개수만큼 색상 순환해 배열 생성
    ...
    datasets: [
      {
        ...
        borderRadius: 8,
        barThickness: view === '일별' ? 10 : 20, // 필터별 막대 너비 설정
        hoverOffset: 10  // 마우스 올렸을 때 효과
      },
    ],
  };
};
